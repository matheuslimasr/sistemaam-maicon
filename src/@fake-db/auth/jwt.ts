...
mock.onPost('/jwt/login').reply(request => {
  ...
  if (user) {
    ...
    console.log("Token JWT l63");

    return [200, response]
  } else {
    error = {
      email: ['Email ou Senha é Inválido']
    }
